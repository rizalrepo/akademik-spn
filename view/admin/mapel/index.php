    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-clipboard-list me-2"></i>Data Mata Pelajaran</h4>
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped dataTable">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $data = $con->query("SELECT * FROM mapel ORDER BY id_mapel DESC");
