...
$query = mysqli_query($con, "SELECT max(kd_mapel) as kode FROM mapel");
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-clipboard-list me-2"></i>Tambah Data Mata Pelajaran</h4>
            ...
            <div class="card card-body border border-danger">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nm_mapel" required>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO mapel VALUES (
        default, 
        '$kode', 
        '$nm_mapel'
    )");
