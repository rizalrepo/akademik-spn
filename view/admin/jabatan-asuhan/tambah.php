    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-user-tag me-2"></i>Tambah Data Jabatan Asuhan</h4>
            ...
            <div class="card card-body border border-danger">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nm_jabatan_asuhan" required>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO jabatan_asuhan VALUES (
        default,
        '$nama'
    )");
