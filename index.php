                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="text-center px-1">
                            <img class="mb-2" src="<?= base_url() ?>/assets/images/logo.png" alt="" height="150">
                            <h6>Login Sistem Akademik <br> Sekolah Polisi Negara POLDA KALSEL</h6>
                        </div>
                        <div class="p-2">
                            <form method="POST" action="" class="needs-validation" novalidate>
                                ...
                                <div class="d-grid">
                                    <button type="submit" name="log" class="btn btn-spn">Login <i class="bi bi-box-arrow-in-right"></i></button>
                                </div>
                            </form>
                        </div>
